...
export class MetadataService {
  private siteMetadata: Object;
  private appName: String;
  constructor(public http: HttpClient, private config: ConfigService, private languageService: LanguageService) {
    try {
      this.siteMetadata = this.config.getSettings('siteMetaData');
    } catch (e) {
      this.siteMetadata = {};
    }
  }
