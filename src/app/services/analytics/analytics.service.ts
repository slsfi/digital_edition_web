...
export class AnalyticsService {
  ...
  public doAnalyticsEvent( category, type, action ) {
  ...
  public doPageView(title, location?, path?) {
    if ( !location ) {
      location = '';
    }
    if ( !path ) {
  ...
  public doAnalyticsEventUA( category, type, action ) {
    try {
  ...
  public doPageViewUA(title, location?, path?) {
    if ( !location ) {
      location = '';
    }
    if ( !path ) {
